...
#Qgram hash the stems, size 4
stemmed_ab_grams <- qgram_hash(strings=stemmed_ab, n=4,k=1) ; dim(stemmed_ab_grams)

#Locality Sensitve Hashing to get suggestions for each stem
#1,006,219 million matches
stemmed_ab_suggestions <- lhs_getpairs(strings=stemmed_ab, grams=stemmed_ab_grams, bands_number=80, rows_per_band=16) ; dim(stemmed_ab_suggestions)
