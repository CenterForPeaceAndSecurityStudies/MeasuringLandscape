...
Cleans and combines a large number of gazeteers of place names for looking up locations by name and retrieving their coordinates.
...
ggsave(
  filename = glue(dir_figures, "flatfiles_sf_roi_facet_source_dataset_points.png"),
...
ggsave(
  filename = glue(dir_figures, "flatfiles_sf_roi_facet_source_dataset_notpoints.png"),
...
ggsave(
  filename = glue(dir_figures, "p_combs_lat.pdf"),
...
ggsave(
  filename = glue(dir_figures, "p_combs_long.pdf"),
