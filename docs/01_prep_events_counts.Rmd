...
# Dates
Basic cleaning. Generally format is DD.MM.YYYY Sometimes multiple days are included by DD1/DD2/MM/YY. Sometimes year is YY or YYYY. 
...
for(i in 1:nrow(events)){
  ...
  suppressMessages({
    temp <- with(events[i,] ,
                 EAGS2LatLong(band=map_coordinate_clean_text_band,
