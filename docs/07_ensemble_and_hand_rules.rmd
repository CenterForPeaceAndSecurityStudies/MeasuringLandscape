...
ggsave(
  filename = glue(dir_figures, "p_ensemble_risiduals.png"), #save as a png because there are too many points and it's crashing the pdf reader
...
pdf(file=glue(dir_figures, "p_variable_importance_supervised_ensemble.pdf"), width=5.5, height=6)
