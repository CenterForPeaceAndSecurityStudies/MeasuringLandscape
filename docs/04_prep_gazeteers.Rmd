...
if (fromscratch) {
  ...
  flatfiles_sf_roi <- readRDS(system.file("extdata", "flatfiles_sf_roi.Rdata", package = "MeasuringLandscapeCivilWar")) %>% # need to rebuild to load it from this location
    distinct(feature_code, latitude, longitude, name, source_dataset, geometry_type, region_of_interest_intersects, name_alternates, .keep_all = T) # This distinct is very important, it's the one the correctly kills dupes not caught

  flatfiles_sf_roi <- flatfiles_sf_roi %>%
    # This distinct is very important, it's the one the
    distinct(feature_code, latitude, longitude, name, source_dataset, geometry_type, region_of_interest_intersects, name_alternates, .keep_all = T) %>%
  ...
  saveRDS(
    flatfiles_sf_roi,
    file = "/home/rexdouglass/Dropbox (rex)/Kenya Article Drafts/MeasuringLandscapeCivilWar/inst/extdata/flatfiles_sf_roi_roi.Rdata"
  )
...
flatfiles_sf_roi <- readRDS(system.file("extdata", "flatfiles_sf_roi_roi.Rdata", package = "MeasuringLandscapeCivilWar"))
...
ggsave(
  filename = "/home/rexdouglass/Dropbox (rex)/Kenya Article Drafts/MeasuringLandscapeCivilWar/analysis/figures/flatfiles_sf_roi_facet_source_dataset_points.png",
...
ggsave(
  filename = "/home/rexdouglass/Dropbox (rex)/Kenya Article Drafts/MeasuringLandscapeCivilWar/analysis/figures/flatfiles_sf_roi_facet_source_dataset_notpoints.png",
...
ggsave(
  filename = "/home/rexdouglass/Dropbox (rex)/Kenya Article Drafts/MeasuringLandscapeCivilWar/analysis/figures/p_combs_lat.pdf",
...
ggsave(
  filename = "/home/rexdouglass/Dropbox (rex)/Kenya Article Drafts/MeasuringLandscapeCivilWar/analysis/figures/p_combs_long.pdf",
