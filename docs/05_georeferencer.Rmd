...
#Load toponym model
#p_load(xgboost)
toponym_xb_model <- xgb.load(system.file("extdata", "toponym_xb_onlystring.bin", package = "MeasuringLandscape"))
...
if(fromscratch){
  ...
  saveRDS(candidates, glue::glue(getwd(), "/inst/extdata/candidates.Rdata")) #Leaving off the .. because you should only be running this by hand
}
