...
glue("Size of the Suggestions dataset ", nrow(georef_all_dt))
...
table(events_sf$name_cleaner %in% georef_all_dt$name_cleaner[!is.na(georef_all_dt$georef_b)]) #7,532 events with at least one gazeteer suggestion
...
ggsave(
  ...
  plot = p_RecallBias, width = 12, height = 6,
