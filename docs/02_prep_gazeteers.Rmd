...
1) NGA - National Geospational Agency
2) Geonames 
3) Historical gazeteer from the time period
4) GoogleMaps
5) BingMaps
6) KEN_adm
...
if (fromscratch) {
  ...
  #                                        package = "MeasuringLandscape")) %>% # need to rebuild to load it from this location
