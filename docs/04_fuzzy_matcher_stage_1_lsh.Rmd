---
title: "04 Fuzzy Matcher Stage 1 (Locality Sensitive Hashing) "
...
if(fromsrcatch){
  ...
  saveRDS(grid_search_lhs_dt,
          glue(getwd(), "/../inst/extdata/grid_search_lhs_dt.Rds"))
}

grid_search_lhs_dt <- readRDS(system.file("extdata", "grid_search_lhs_dt.Rds", package = "MeasuringLandscapeCivilWar"))
...
ggplot(grid_search_lhs_dt, aes(x=false_negative,y=suggestions_per, label=bands)) + geom_label() + ggtitle("")
